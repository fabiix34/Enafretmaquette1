      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <div className="text-center">
              <div className="text-orange-600 text-3xl font-bold mb-2">24h</div>
              <p className="text-gray-600">Délai de réponse</p>
            </div>
            <div className="text-center">
              <div className="text-orange-600 text-3xl font-bold mb-2">100%</div>
              <p className="text-gray-600">Devis gratuit</p>
            </div>
            <div className="text-center">
              <div className="text-orange-600 text-3xl font-bold mb-2">+15 ans</div>
